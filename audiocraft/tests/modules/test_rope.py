...
from audiocraft.audiocraft.modules.rope import RotaryEmbedding
from audiocraft.audiocraft.modules.transformer import StreamingTransformer, set_efficient_attention_backend
