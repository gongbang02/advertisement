...
from controlnet.annotator.oneformer.detectron2.layers import ShapeSpec
from controlnet.annotator.oneformer.detectron2.structures import Boxes, Instances, pairwise_iou
