...
from controlnet.annotator.oneformer.detectron2.layers import Conv2d, ShapeSpec, get_norm
from controlnet.annotator.oneformer.detectron2.structures import ImageList
