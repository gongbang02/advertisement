...
from controlnet.annotator.oneformer.detectron2.modeling import Backbone
from controlnet.annotator.oneformer.detectron2.structures import Boxes, ImageList, Instances
