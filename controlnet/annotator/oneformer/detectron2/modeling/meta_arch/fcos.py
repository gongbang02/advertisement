...
from controlnet.annotator.oneformer.detectron2.layers import ShapeSpec, batched_nms
from controlnet.annotator.oneformer.detectron2.structures import Boxes, ImageList, Instances, pairwise_point_box_distance
